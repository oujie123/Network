 ...
 */
package com.gacrnd.gcs.okhttp.okhttp3.internal.http1;

import com.gacrnd.gcs.okhttp.okhttp3.Headers;
import com.gacrnd.gcs.okhttp.okhttp3.HttpUrl;
import com.gacrnd.gcs.okhttp.okhttp3.OkHttpClient;
import com.gacrnd.gcs.okhttp.okhttp3.ResponseBody;
import com.gacrnd.gcs.okhttp.okhttp3.internal.Internal;
import com.gacrnd.gcs.okhttp.okhttp3.internal.Util;
import com.gacrnd.gcs.okhttp.okhttp3.internal.connection.RealConnection;
import com.gacrnd.gcs.okhttp.okhttp3.internal.connection.StreamAllocation;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.HttpCodec;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.HttpHeaders;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.RealResponseBody;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.RequestLine;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.StatusLine;
...
public final class Http1Codec implements HttpCodec {
  ...
  @Override public Sink createRequestBody(Request request, long contentLength) {
    // todo 如果是未知长度，直接返回newChunkedSink
  ...
  @Override public Response.Builder readResponseHeaders(boolean expectContinue) throws IOException {
    ...
    try {
      ...
      // todo 如果返回的是100 返回null，继续传输剩下的大数据
