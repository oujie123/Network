 ...
 */
package com.gacrnd.gcs.okhttp.okhttp3.internal.cache;

import androidx.annotation.Nullable;

import com.gacrnd.gcs.okhttp.okhttp3.internal.Internal;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.HttpDate;
...
public final class CacheStrategy {
    ...
    public static boolean isCacheable(Response response, Request request) {
        ...
        switch (response.code()) {
            //todo 对于 200, 203, 204, 300, 301, 404, 405, 410, 414, 501, 308 只判断是不是存在 cache-control:nostore 不缓存
            // 302, 307 需要存在: Expires:时间、CacheControl:max-age/public/private 才判断是不是存在 cache-control:nostore
            // 才能够缓存
            // 其他响应码不缓存
            case HTTP_OK:
            ...
            case StatusLine.HTTP_PERM_REDIRECT:
                ...
                // todo 如果以上响应码，头中没有明确nostore那就缓存
                break;
            ...
            case StatusLine.HTTP_TEMP_REDIRECT:
                ...
                // s-maxage.
                // todo 如果响应码是302和307，需要存在 Expires:时间、CacheControl:max-age/public/private 且没有cache-control:nostore才缓存
    ...
    public static class Factory {
        ...
        private CacheStrategy getCandidate() {
            ...
            // response body will not be transmitted.
            //todo 7、缓存过期了
            ...
            // todo 由于是缓存过期而发起的请求(与第4个判断用户的主动设置不同)，如果服务器返回304，那框架会自动更新缓存，所以此时`CacheStrategy`既包含`networkRequest`也包含`cacheResponse
