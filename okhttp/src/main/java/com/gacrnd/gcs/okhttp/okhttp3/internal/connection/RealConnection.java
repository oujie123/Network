 ...
 */
package com.gacrnd.gcs.okhttp.okhttp3.internal.connection;

import androidx.annotation.Nullable;

import com.gacrnd.gcs.okhttp.okhttp3.Address;
import com.gacrnd.gcs.okhttp.okhttp3.Route;
import com.gacrnd.gcs.okhttp.okhttp3.internal.Internal;
import com.gacrnd.gcs.okhttp.okhttp3.internal.Util;
import com.gacrnd.gcs.okhttp.okhttp3.internal.Version;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http.HttpCodec;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http1.Http1Codec;
import com.gacrnd.gcs.okhttp.okhttp3.internal.http2.Http2Codec;
import com.gacrnd.gcs.okhttp.okhttp3.internal.platform.Platform;
...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int connectTimeout, int readTimeout, Call call,
        ...
        // todo 如果是Socks代理则 new Socket(proxy); 否则相当于直接:new Socket()
        // todo 设置了SOCKS代理的情况下，创建Socket时，为其传入proxy，连接时还是以HTTP服务器为目标地址；但是如果设置的是Http代理，创建Socket是与Http代理服务器建立连接。
